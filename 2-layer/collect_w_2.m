...
Scalar  = 255;          %   Mode scaling with height : matches with single-layer calculation
sigma   = 1;
...
[ xx, zz, ww, bb ] = series_half_sinusoid_plots_3_copy_no_checks2(HL_bar , HV_bar, Ht_bar, t, T, Scalar * HL_bar , sigma );
