...
line(x1,bb1p,'parent',ax(1),'Color','m','LineWidth',2,  'linestyle','--')                  
line(x1,ww1p,'parent',ax(2),'Color','c','LineWidth',2,  'linestyle','--')                   
line(x1,bb2p,'parent',ax(1),'Color','m','LineWidth',2                   )
line(x1,ww2p,'parent',ax(2),'Color','c','LineWidth',2                   )
grid on
set(ax(1),'xlim',[-20 20]);
set(ax(2),'xlim',[-20 20]);
set(h1,'LineWidth',2);
